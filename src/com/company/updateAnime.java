...
public class updateAnime extends JFrame {
    ...
    public updateAnime(JTable table1) {
    ...
    public void setTxtStudio(String txtStudio) {
        this.txtStudio.setText(txtStudio);
    }

    public void setTxtDemo(String txtDemo) {
        this.txtDemo.setText(txtDemo);
    }

    public void setTxtEpisodes(String txtEpisodes) {
        this.txtEpisodes.setText(txtEpisodes);
    }
